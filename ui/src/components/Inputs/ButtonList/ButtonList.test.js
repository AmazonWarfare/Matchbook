...
import ButtonList from "./ButtonList"; // import unit under test
...
describe('Button List Tests', () => { // describe (part of Jest) takes a string describing the test suite and a function () => {...}
    ...
    it('should have div button-list as first and only child', () => {
        expect(wrapper.children()).to.have.lengthOf(1); // wrapper methods like children() and find() are used to inspect
        expect(wrapper.find('div.button-list')).to.have.lengthOf(1); // the correctness of the component mocked above
    });
    it('should have as first and only child of div button-list', () => {
        expect(wrapper.children()).to.have.lengthOf(1); // wrapper methods like children() and find() are used to inspect
        expect(wrapper.find('div.button-list')).to.have.lengthOf(1); // the correctness of the component mocked above
    });
