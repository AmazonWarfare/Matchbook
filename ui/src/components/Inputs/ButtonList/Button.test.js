...
import Button from "./Button"; // import unit under test
...
describe('Button Tests', () => { // describe (part of Jest) takes a string describing the test suite and a function () => {...}
    ...
    it('should have buttonDiv as first and only child', () => {
        expect(wrapper.children()).to.have.lengthOf(1); // wrapper methods like children() and find() are used to inspect
        expect(wrapper.find('div.button')).to.have.lengthOf(1); // the correctness of the component mocked above
    });
